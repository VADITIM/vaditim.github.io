<template>
  <div ref="rootRef" class="classified-section">
    ...
    <ModuleDisplay ref="qrPanelRef" accent="#8a2be2" class="sc-qr-panel" caption="scan at your own risk">
      <template #label>03 · ARCHIVE</template>
    ...
    <div class="sc-grid">
      <ModuleDisplay ref="panelRef" accent="#8a2be2" class="sc-panel" caption="unlocked via QR scan">
...
<script setup lang="ts">
  ...
  const CLASSIFIED_LABELS = [
    { text: 'YOU SCANNED IT', pos: { top: '5%', left: '10%' }, stretch: true },
    { text: 'WELCOME IN', pos: { bottom: '5%', right: '10%' } },
    { text: 'NOTHING HERE IS REAL', pos: { bottom: '4%', left: '2%' } },
  ]
