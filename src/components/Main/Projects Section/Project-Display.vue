...
<script setup lang="ts">
  ...
  import { activeProjectIndex, closeActiveProject, currentProjectIndex, projects } from '@modules/sectionsProjects';
  import { clicked } from '@modules/sectionsProjectsTechnology';
