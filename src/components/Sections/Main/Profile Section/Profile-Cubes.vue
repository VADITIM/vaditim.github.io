...
<script setup lang="ts">
  ...
  import { onSectionStatesChange, type SectionTransitionMeta } from '@modules/Sections/section-state-machine';
  ...
  import { hideLabels, playLabelReveals, playLabelLeave } from '@modules/Misc/label-reveal';
