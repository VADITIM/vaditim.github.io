...
import ClassifiedPage from '@components/Main/Classified Section/Classified-Section.vue';
...
import { registerClassifiedAnimations } from './sectionsClassifiedAnimationHandler';
...
export const SECTIONS: SectionDefinition[] = [
	...
	{ id: 'classified', label: 'CLASSIFIED', color: '#8a2be2', component: ClassifiedPage, registerAnimations: registerClassifiedAnimations },
];
